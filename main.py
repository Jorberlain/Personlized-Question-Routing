...
def runPDER(options):
    ...
    if options.gen_mp:
        ...
        walks = mp_generator.generate_metapaths_2( # 可修改
...
if __name__ == '__main__':
    ...
    parser.add_option("-r", "--learning-rate", type="float",
                      dest="learning_rate", default=0.003,
